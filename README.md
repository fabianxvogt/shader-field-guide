...
**Public preview / full-v1 still open.** The reviewed ordinary source is public at [github.com/fabianxvogt/shader-field-guide](https://github.com/fabianxvogt/shader-field-guide), branch `codex/v1`. The accepted product source remains `35f5d4005835df184d106b4a96d122d2b95296fc` (`Contain desktop shader output controls`), a CSS-only delta. This revision adds only public-safe release evidence: the retained runtime package excludes incidental `dist/server/.wrangler` cache sidecars, leaving 59 reviewed runtime files, and the real 35f desktop/narrow smoke passed output-control reachability with WebGL2 and no page/console errors. Public Site version 3 remains live at [shader-field-guide.fabian523417.chatgpt.site](https://shader-field-guide.fabian523417.chatgpt.site) from prior product source `011ef89dc5b0860b64c40b3e2dfd7ae091645e2a`. Versions 4 and 5 remain obsolete undeployed candidates; the clean package revision is saved privately and is not deployed pending root decision. This is not a full-v1, device, human, or sustained-performance claim.
