...
**Public preview / full-v1 still open.** The reviewed ordinary source is public at [github.com/fabianxvogt/shader-field-guide](https://github.com/fabianxvogt/shader-field-guide), branch `codex/v1`. The current accepted product source is `8e6656d8e772ee92f3c2839d7764e853b50e69e6` (`Wrap narrow shader output actions`). Public Site version 3 remains live at [shader-field-guide.fabian523417.chatgpt.site](https://shader-field-guide.fabian523417.chatgpt.site) from the prior product source `011ef89dc5b0860b64c40b3e2dfd7ae091645e2a`. Private Site version 4 is saved from `8e6656d…` but is not deployed, pending independent 390px confirmation and root decision. This is not a full-v1, device, human, or sustained-performance claim.
