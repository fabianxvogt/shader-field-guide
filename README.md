...
**Public preview / full-v1 still open.** The reviewed ordinary source is public at [github.com/fabianxvogt/shader-field-guide](https://github.com/fabianxvogt/shader-field-guide), branch `codex/v1`. The accepted runtime product base remains `35f5d4005835df184d106b4a96d122d2b95296fc`; final source `b05898e4db5f3ebd4fd1527e58d80ab7827fe248` adds the CSS-only intrinsic-width output-row fix. Public Site version 7 is now live at [shader-field-guide.fabian523417.chatgpt.site](https://shader-field-guide.fabian523417.chatgpt.site) from exact b058 source. Its clean runtime package contains 59 logical payload files. The b058 desktop/narrow smoke passed output-control content fit with WebGL2 and no page/console errors. This is not a full-v1, device, human, or sustained-performance claim.
...
Source fixtures cover all five lesson expressions, generated GLSL, injection rejection, caps, challenge properties, and the bounded export lifecycle. Separate isolated QA observed WebGL2, a real bounded GLSL edit/compile, notebook save/reload/load/delete/reload, and two-tab convergence. The b058 browser review covered real 1280px and 390px viewports: output button boxes and contents fit, WebGL2 was live, and no page/console errors were observed. The public root returned `200 text/html`; its real GLSL, notebook, Config JSON, and PNG controls are present. The clean release package contains 59 logical payload files. Cloudflare may transform HTML responses, so they are not compared as raw archive bytes. Build and lint are local checks, not CI evidence.
